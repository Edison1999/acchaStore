  ...
  (this.wp.a11y = (function (t) {
    ...
    459: function (t, e, n) {
      ...
      function a() {
        ...
        var n = document,
          r = n.body;
        return r && r.appendChild(e), e;
      }
      var u = "";
      function p() {
        var t = document.getElementById("a11y-speak-intro-text"),
        ...
        null === t &&
          (function () {
            ...
            (t.id = "a11y-speak-intro-text"),
              ...
              (t.textContent = Object(o.__)("Notifications")),
              t.setAttribute(
                "style",
                "position: absolute;margin: -1px;padding: 0;height: 1px;width: 1px;overflow: hidden;clip: rect(1px, 1px, 1px, 1px);-webkit-clip-path: inset(50%);clip-path: inset(50%);border: 0;word-wrap: normal !important;"
              ),
      ...
      function d(t, e) {
        !(function () {
          for (
            var t = document.getElementsByClassName("a11y-speak-region"),
        ...
        var n = document.getElementById("a11y-speak-intro-text"),
          r = document.getElementById("a11y-speak-assertive"),
          i = document.getElementById("a11y-speak-polite");
        r && "assertive" === e ? (r.textContent = t) : i && (i.textContent = t),
