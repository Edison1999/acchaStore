  ...
  return r.widget("ui.slider", r.ui.mouse, {
        ...
        ? (!0 === e.range &&
            (e.values
              ? e.values.length && 2 !== e.values.length
                ...
                : r.isArray(e.values) && (e.values = e.values.slice(0))
    ...
    _trimAlignValue: function (e) {
      ...
      var t = 0 < this.options.step ? this.options.step : 1,
        ...
        s = e - i;
      return (
        2 * Math.abs(i) >= t && (s += 0 < i ? t : -t), parseFloat(s.toFixed(5))
      );
    },
      ...
      this.options.values && this.options.values.length
              ...
              !0 === l.options.range &&
                ("horizontal" === l.orientation
                  ? (0 === e &&
                      l.range
                        .stop(1, 1)
                        [o ? "animate" : "css"]({ left: i + "%" }, h.animate),
                    1 === e &&
                      l.range[o ? "animate" : "css"](
                        { width: i - t + "%" },
                  ...
                  : (0 === e &&
                      l.range
                        .stop(1, 1)
                        [o ? "animate" : "css"]({ bottom: i + "%" }, h.animate),
                    1 === e &&
                      l.range[o ? "animate" : "css"](
                        { height: i - t + "%" },
                        { queue: !1, duration: h.animate }
        ...
        : ((e = this.value()),
          ...
          "min" === n &&
            ...
            this.range
              .stop(1, 1)
              [o ? "animate" : "css"]({ width: i + "%" }, h.animate),
          "max" === n &&
            "horizontal" === this.orientation &&
          ...
          "min" === n &&
            ...
            this.range
              .stop(1, 1)
              [o ? "animate" : "css"]({ height: i + "%" }, h.animate),
          "max" === n &&
            "vertical" === this.orientation &&
            this.range[o ? "animate" : "css"](
              { height: 100 - i + "%" },
    ...
    _handleEvents: {
      keydown: function (e) {
        var t,
          i,
          s,
          a = r(e.target).data("ui-slider-handle-index");
        switch (e.keyCode) {
