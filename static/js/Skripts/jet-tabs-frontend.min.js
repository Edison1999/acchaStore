!(function (t, e) {
  ...
  "Promise" in l
    ? l.Promise.prototype.finally || (l.Promise.prototype.finally = t)
    : (l.Promise = o);
}),
  (function (t, e, n) {
    "use strict";
    var o = {
      ...
      tabsInit: function (e) {
        var n,
          a = t(".jet-tabs", e).first(),
          i = (a.data("id"), t(window)),
          r = t(".jet-tabs__control-wrapper", a).first(),
          c = t(".jet-tabs__content-wrapper", a).first(),
          s = t("> .jet-tabs__control", r),
          d = t("> .jet-tabs__content", c),
          l = a.data("settings") || {},
          u = [],
          f = null,
        ...
        if (
          ("click" === l.event
            ? s.on("click.jetTabs", function () {
                var e = t(this),
                  n = +e.data("tab") - 1,
                  o = e.data("template-id");
                clearInterval(f), l.ajaxTemplate && o && v(n), w(n);
              })
            ...
            ? (s.on("touchstart", function (e) {
              ...
              s.on("touchend", function (e) {
                ...
                clearInterval(f), l.ajaxTemplate && i && v(a), w(a);
              }))
            : s.on("mouseenter", function (e) {
                var n = t(this),
                  o = +n.data("tab") - 1,
                  a = n.data("template-id");
                clearInterval(f), l.ajaxTemplate && a && v(o), w(o);
              }),
          l.autoSwitch)
        ) {
          var p = l.activeIndex,
          ...
          f = setInterval(function () {
            p < m - 1 ? p++ : (p = 0), l.ajaxTemplate && v(p), w(p);
          }, +l.autoSwitchDelay);
        }
        function w(t) {
          var e,
          ...
          c.css({ height: c.outerHeight(!0) }),
            ...
            (r = o.outerHeight(!0)),
            (r +=
              parseInt(c.css("border-top-width")) +
              parseInt(c.css("border-bottom-width"))),
            o.addClass("active-content"),
            d.attr("aria-hidden", "true"),
            o.attr("aria-hidden", "false"),
            c.css({ height: r }),
            i.trigger("jet-tabs/tabs/show-tab-event/before", {
              target: a,
              tabIndex: t,
            }),
            e && clearTimeout(e),
            (e = setTimeout(function () {
              i.trigger("jet-tabs/tabs/show-tab-event/after", {
                target: a,
                tabIndex: t,
              }),
                c.css({ height: "auto" });
            ...
            t.ajax({
              ...
              success: function (t, e, a) {
                var i = t.template_content,
                  ...
                  s = t.template_styles;
                for (var d in c)
                  o.addedAssetsPromises.push(o.loadScriptAsync(d, c[d]));
                for (var l in s)
                  o.addedAssetsPromises.push(o.loadStyle(l, s[l]));
                Promise.all(o.addedAssetsPromises).then(
                  function (t) {
        ...
        l.ajaxTemplate && v(l.activeIndex),
          t(window).on("resize.jetTabs orientationchange.jetTabs", function () {
            c.css({ height: "auto" });
          }),
          g &&
            s.each(function (e) {
              ...
              g.forEach(function (t, e) {
                t === o && (l.ajaxTemplate && a && v(i), w(i));
              });
            }),
          s.each(function () {
            u.push('a[href*="#' + t(this).attr("id") + '"]');
          }),
          t(document).on("click.jetTabAnchor", u.join(","), function (n) {
            var o = t(this.hash);
            if (o.closest(e)[0]) {
              var a = o.data("tab") - 1;
              l.ajaxTemplate && v(a), w(a);
            }
          });
      },
      switcherInit: function (e) {
        var n,
          o = t(".jet-switcher", e).first(),
          a = (o.data("id"), t(window)),
          i = t(".jet-switcher__control-wrapper", o).first(),
          r = t(".jet-switcher__content-wrapper", o).first(),
          c = t("> .jet-switcher__control-instance", i),
          s = t(
            "> .jet-switcher__control-instance > .jet-switcher__control, > .jet-switcher__control",
            i
          ),
          d = t("> .jet-switcher__content", r),
          l =
            (t("> .jet-switcher__content--disable", r),
            t("> .jet-switcher__content--enable", r),
            o.hasClass("jet-switcher--disable"));
        o.data("settings");
        function u(t) {
          var e,
            n,
            i,
            c = "auto";
          r.css({ height: r.outerHeight(!0) }),
            o.toggleClass("jet-switcher--disable jet-switcher--enable"),
            (e = (l = !o.hasClass("jet-switcher--disable"))
              ? s.eq(1)
              : s.eq(0)),
            (n = l ? d.eq(1) : d.eq(0)),
            d.removeClass("active-content"),
            ...
            n.addClass("active-content"),
            s.attr("aria-expanded", "false"),
            e.attr("aria-expanded", "true"),
            d.attr("aria-hidden", "true"),
            n.attr("aria-hidden", "false"),
            r.css({ height: c }),
            a.trigger("jet-tabs/switcher/show-case-event/before", {
              target: o,
              caseIndex: t,
            }),
            i && clearTimeout(i),
            (i = setTimeout(function () {
              a.trigger("jet-tabs/switcher/show-case-event/after", {
                target: o,
                caseIndex: t,
              }),
                r.css({ height: "auto" });
        ...
        "ontouchend" in window || "ontouchstart" in window
          ...
          t(window).on(
            "resize.jetSwitcher orientationchange.jetSwitcher",
            function () {
              r.css({ height: "auto" });
            }
          );
      ...
      accordionInit: function (e) {
        var n,
          a,
          i = t(".jet-accordion", e).first(),
          r = (i.data("id"), t(window)),
          c = t(
            "> .jet-accordion__inner > .jet-toggle > .jet-toggle__control",
            i
          ),
          s = i.data("settings"),
          d = t("> .jet-accordion__inner > .jet-toggle", i),
          l = [],
        ...
        function h(e) {
          ...
          if (r) return !1;
          a.data("template-loaded", !0),
            t.ajax({
              type: "GET",
              url: window.JetTabsSettings.templateApiUrl,
              dataType: "json",
              data: { id: c, dev: window.JetTabsSettings.devMode },
              success: function (t, e, n) {
                var a = t.template_content,
                  r = t.template_scripts,
                  c = t.template_styles;
                for (var d in r)
                  o.addedAssetsPromises.push(o.loadScriptAsync(d, r[d]));
                for (var l in c)
                  o.addedAssetsPromises.push(o.loadStyle(l, c[l]));
                Promise.all(o.addedAssetsPromises).then(
                  function (t) {
        ...
        t(window).on(
          "resize.jetAccordion orientationchange.jetAccordion",
          function () {
          ...
          c.on("click.jetAccordion", function () {
            var e = t(this),
              ...
              c = +e.data("toggle") - 1;
            if (s.collapsible)
              o.hasClass("active-toggle") ||
                d.each(function (e) {
                  var o = t(this),
                    d = t("> .jet-toggle__control", o),
                  ...
                  (u +=
                    ...
                    parseInt(l.css("border-bottom-width"))),
                    e === c
                      ? (o.addClass("active-toggle"),
                        l.css({ height: u }),
                        d.attr("aria-expanded", "true"),
                        l.attr("aria-hidden", "false"),
                        s.ajaxTemplate && h(c),
                        r.trigger(
                          "jet-tabs/accordion/show-toggle-event/before",
                          { target: i, toggleIndex: c }
                        ),
                        n && clearTimeout(n),
                        (n = setTimeout(function () {
                          r.trigger(
                            "jet-tabs/accordion/show-toggle-event/after",
                            { target: i, toggleIndex: c }
                          ),
                            l.css({ height: "auto" });
                        }, 300)))
              ...
              (u +=
                parseInt(l.css("border-top-width")) +
                parseInt(l.css("border-bottom-width"))),
                o.toggleClass("active-toggle"),
                o.hasClass("active-toggle")
                  ? (l.css({ height: u }),
                    e.attr("aria-expanded", "true"),
                    l.attr("aria-hidden", "false"),
                    s.ajaxTemplate && h(c),
                    r.trigger("jet-tabs/accordion/show-toggle-event/before", {
                      target: i,
                      toggleIndex: c,
                    }),
                    n && clearTimeout(n),
                    (n = setTimeout(function () {
                      r.trigger("jet-tabs/accordion/show-toggle-event/after", {
                        target: i,
                        toggleIndex: c,
                      }),
                        l.css({ height: "auto" });
          ...
          c.each(function () {
            l.push('a[href*="#' + t(this).attr("id") + '"]');
          }),
          t(document).on("click.jetAccordionAnchor", l.join(","), function (n) {
            var o = t(this.hash);
      ...
      imageAccordionInit: function (e) {
        var n,
          o = t(".jet-image-accordion", e);
        o.length &&
          ((n = o.data("settings")), new jetImageAccordion(o, n).init());
      },
      loadScriptAsync: function (t, e) {
        return o.addedScripts.hasOwnProperty(t)
          ? t
          : e
          ? ((o.addedScripts[t] = e),
      ...
      loadStyle: function (t, e) {
        return o.addedStyles.hasOwnProperty(t) && o.addedStyles[t] === e
          ? t
          : e
          ? ((o.addedStyles[t] = e),
            new Promise(function (n, o) {
    ...
    (window.jetImageAccordion = function (e, n) {
      ...
      (n = t.extend(
        ...
        (this.layoutBuild = function () {
          r.css({ "transition-duration": n.duration + "ms" }),
            r.each(function (e) {
              e === o &&
                (t(this).addClass("active-accordion"), a.layoutRender());
            }),
            t(".jet-image-accordion__image-instance", r)
              .imagesLoaded()
        ...
        (this.layoutRender = function (e) {
          ...
          t(".jet-image-accordion__item:not(.active-accordion)", i).css({
            ...
            t(".active-accordion", i).css({ "flex-grow": a });
        }),
        (this.addEvents = function () {
          var e = t(window).scrollTop();
          "ontouchend" in window || "ontouchstart" in window
            ? (r.on("touchstart.jetImageAccordion", function (n) {
              ...
              r.on("touchend.jetImageAccordion", function (n) {
                ...
                o.hasClass("active-accordion")
                  ? r.removeClass("active-accordion")
                  : (r.removeClass("active-accordion"),
                    o.addClass("active-accordion")),
                  a.layoutRender();
              }))
            : r.on("mouseenter", function (e) {
                var n = t(this);
                n.hasClass("active-accordion") ||
                  (r.removeClass("active-accordion"),
                  n.addClass("active-accordion")),
                  a.layoutRender();
              }),
            i.on("mouseleave.jetImageAccordion", function (t) {
              r.removeClass("active-accordion"),
                -1 !== o && r.eq(o).addClass("active-accordion"),
                a.layoutRender();
            });
        }),
        (this.init = function () {
