!(function (e, t) {
  ...
  var i = {
    ...
    widgetCountdown: function (t) {
      var a,
        ...
        s = o.data("due-date"),
        l = o.data("start-date"),
        d = o.data("expire-actions"),
        c = o.data("evergreen-interval"),
        u = o.data("restart-interval"),
        p = {
      ...
      (i.widgetCountdown.initClock = function () {
        switch (n) {
          ...
          case "endless":
            var e = new Date();
            e > new Date(1e3 * l) && (r = new Date(1e3 * (l + u))),
              r &&
                e > r &&
                (r = r.setSeconds(
                  r.getSeconds() + (Math.floor((e - r) / (1e3 * u)) + 1) * u
                ));
        }
        i.widgetCountdown.updateClock(),
          (a = setInterval(i.widgetCountdown.updateClock, 1e3));
      }),
        (i.widgetCountdown.updateClock = function () {
          if (r) {
            ...
            e.each(t.parts, function (e) {
              ...
              t.total <= 0 &&
                (clearInterval(a), i.widgetCountdown.runActions());
          }
        }),
        ...
        (i.widgetCountdown.getTimeRemaining = function (e, t) {
          var a = e - new Date(),
          ...
          return (
            (s < 0 || r < 0 || n < 0) && (o = n = r = s = 0),
            t.days || ((r += 24 * s), (s = 0)),
            t.hours || ((n += 60 * r), (r = 0)),
            t.minutes || ((o += 60 * n), (n = 0)),
            {
              total: a,
              parts: {
                days: i.widgetCountdown.splitNum(s),
                hours: i.widgetCountdown.splitNum(r),
                minutes: i.widgetCountdown.splitNum(n),
                seconds: i.widgetCountdown.splitNum(o),
              },
            }
          );
        }),
              ...
              e.each(d, function (e, n) {
                switch (n) {
                  ...
                  case "hide":
                    ...
                    break;
                  case "restart":
                    (r = (r = new Date()).setSeconds(r.getSeconds() + u)),
                      i.widgetCountdown.updateClock(),
                      (a = setInterval(i.widgetCountdown.updateClock, 1e3));
                }
              });
    ...
    widgetMap: function (t) {
      ...
      window.google &&
        ...
        ((a = n.data("init")),
        (o = n.data("pins")),
        (i = new google.maps.Map(n[0], a)),
        o &&
          e.each(o, function (e, t) {
            var a,
              o,
              n = { position: t.position, map: i };
            "" !== t.image && (n.icon = t.image),
              (a = new google.maps.Marker(n)),
              "" !== t.desc &&
              ...
              a.addListener("click", function () {
                o.setOptions({ disableAutoPan: !1 }), o.open(i, a);
              }),
    ...
    widgetProgress: function (t) {
      var a = t.find(".circle-progress");
      if (a.length) {
        var o = a.find(".circle-progress__value"),
          n = a.find(".circle-progress__meter"),
          r = parseInt(o.data("value")) / 100,
          s = t.find(".circle-progress-wrap").data("duration"),
          l = a.data("responsive-sizes"),
          d = l.desktop,
          c = l.tablet,
          u = l.mobile,
        ...
        "tablet" === p &&
          ...
          elementorFrontend.waypoint(
            ...
            function () {
              ...
              n && (i.rounding = n[1].length), (i.duration = s), e.numerator(i);
              var l = parseInt(a.data("circumference")) * (1 - r);
              o.css({ transitionDuration: s + "ms", strokeDashoffset: l }),
                (m = !0);
            },
          ...
          e(window).on(
            ...
            function (e) {
              "desktop" === (p = elementorFrontend.getCurrentDeviceMode()) &&
                "desktop" !== f &&
                (g(
                  d.size,
                  d.viewBox,
      ...
      function g(e, t, i, s, l, d, c) {
        ...
        a.attr({
          ...
          a[0].setAttribute("viewBox", t),
          n.attr({ cx: i, cy: i, r: s, "stroke-width": d }),
          m && o.css({ transitionDuration: "" }),
          o.attr({ cx: i, cy: i, r: s, "stroke-width": l }),
          o.css({ strokeDasharray: c, strokeDashoffset: m ? u : c });
      }
    },
    ...
    widgetPosts: function (e) {
      ...
      t.length &&
        ((a.slide = ".jet-posts__item"),
        i.initCarousel(t.find(".jet-posts"), a));
    },
    ...
    widgetAnimatedBox: function (a) {
      ...
      if (r.length)
        switch (s.switchEventType) {
              ...
              ? (r.on("touchstart", function (t) {
                ...
                e(document).on("touchend", function (t) {
                  e(t.target).closest(r).length ||
                    r.hasClass("flipped-stop") ||
                    (r.hasClass("flipped") && r.removeClass("flipped"));
                }))
              : r.on("mouseenter mouseleave", function (t) {
                  (d && "mouseleave" === t.type) ||
                    (d && "mouseenter" === t.type && (d = !1),
          ...
          case "toggle":
            "ontouchend" in window || "ontouchstart" in window
              ? r.on("touchstart", ".jet-animated-box__toggle", function (e) {
              ...
              e("html, body").scrollTop(0),
                html2canvas(
                  document.querySelector(
                    "#jet-animated-box__front-" + s.widgetId
                  ),
                  {
                    allowTaint: !0,
                  ...
                  i.setAttribute("id", "jet-animated-box-canvas-" + s.widgetId),
                    r.prepend(i),
                    e(".jet-animated-box__front", r).fadeOut(300, function () {
                      e(this).remove();
                    }),
                    e(window).one("resize.jetScratch", function (a) {
                      e(window).width() !== t &&
                        ((t = e(window).width()),
                        e(i).fadeOut(250, function () {
                          e(this).remove();
                        }));
                    });
                  new jetScratchEffect(
                    "#jet-animated-box-" + s.widgetId,
                    "#jet-animated-box-canvas-" + s.widgetId,
                    function () {
          ...
          case "fold":
            !(function () {
              ...
              }).accordion(0, s.paperFoldDirection),
                r.addClass("fold-init");
            })();
            break;
          case "peel":
            !(function () {
              ...
              e(".jet-animated-box__front", r).addClass("peel-top"),
                t.removeAttr("id"),
                t.addClass("peel-back"),
                t.insertAfter("#jet-animated-box__front-" + s.widgetId),
                e(".jet-animated-box__back", r).addClass("peel-bottom");
              var i = new Peel("#jet-animated-box-" + s.widgetId, {
                  corner: Peel.Corners.TOP_RIGHT,
                }),
                a = r.width();
              r.height();
              i.setPeelPosition(a - 30, 40),
                i.setFadeThreshold(0.8),
                i.handleDrag(function (t, a, o) {
                  var n = r.offset(),
                    s = n.left,
                    l = n.top,
                    d = a - s,
                  ...
                  (d = d < 0 ? (d *= 3) : d),
                    ...
                    i.setPeelPosition(Math.round(d), Math.round(c));
                });
            })();
            break;
          case "slide-out":
            (o = e(".jet-animated-box__front", r)),
              e(".jet-animated-box__back", r),
              r.width(),
              r.height(),
              (n =
                "left" === s.slideOutDirection ||
                "right" === s.slideOutDirection
                  ? "x"
                  : "y"),
              o.draggable({
                axis: n,
    ...
    onAnimatedBoxSectionActivated: function (e) {
      if (
        ...
        -1 !==
        ["section_back_content", "section_action_button_style"].indexOf(t)
    ...
    widgetPortfolio: function (t) {
      var i = t.find(".jet-portfolio"),
        a = { id: t.data("id") };
      i.length &&
        ((a = e.extend({}, a, i.data("settings"))),
        new jetPortfolio(i, a).init());
    },
    widgetInstagramGallery: function (t) {
      var i,
        a,
        o = t.find(".jet-instagram-gallery__instance");
      o.length &&
        ((a = o.data("settings")),
        (i = {
          layoutType: "masonry",
        ...
        e.extend(i, a),
        "masonry" === a.layoutType && salvattore.init());
    },
            ...
            (r = e.ajax({
              ...
              success: function (t) {
                ...
                p.removeClass("loading"),
                  ...
                  setTimeout(function () {
                    f.css({ visibility: "hidden" }), i.removeClass(s);
                  }, 2e4),
                  n.redirect && (window.location.href = n.redirect_url),
                  e(window).trigger({
    ...
    widgetSlider: function (i) {
      var a = i.find(".jet-slider"),
        o = (e(".sp-image", a), a.data("settings") || {}),
        n = e.extend(
          {},
          {
      ...
      if (a.length) {
        var r =
            "" !== n.sliderHeightTablet.size
              ? n.sliderHeightTablet.size + n.sliderHeightTablet.unit
              : n.sliderHeight.size + n.sliderHeight.unit,
          s =
            "" !== n.sliderHeightMobile.size
              ? n.sliderHeightMobile.size + n.sliderHeightMobile.unit
              : r,
          l =
            "" !== n.thumbnailWidthTablet
              ? n.thumbnailWidthTablet
              : n.thumbnailWidth,
          d = "" !== n.thumbnailWidthMobile ? n.thumbnailWidthMobile : l,
          c =
            "" !== n.thumbnailHeightTablet
              ? n.thumbnailHeightTablet
              : n.thumbnailHeight,
          u = "" !== n.thumbnailHeightMobile ? n.thumbnailHeightMobile : l,
          p =
            void 0 !== t.config.breakpoints.lg
              ? t.config.breakpoints.lg - 1
              : 1023,
          f =
            void 0 !== t.config.breakpoints.md
              ? t.config.breakpoints.md - 1
              : 767,
          m = {};
        t.isEditMode() && (f -= 17),
          (m[p] = { height: r, thumbnailWidth: l, thumbnailHeight: c }),
          (m[f] = { height: s, thumbnailWidth: d, thumbnailHeight: u }),
          e(".slider-pro", a).sliderPro({
            width: n.sliderWidth.size + n.sliderWidth.unit,
            height: n.sliderHeight.size + n.sliderHeight.unit,
            arrows: n.sliderNavigation,
            fadeArrows: n.sliderNaviOnHover,
            buttons: n.sliderPagination,
            autoplay: n.sliderAutoplay,
            autoplayDelay: n.sliderAutoplayDelay,
            autoplayOnHover: n.sliderAutoplayOnHover,
            fullScreen: n.sliderFullScreen,
            shuffle: n.sliderShuffle,
            loop: n.sliderLoop,
            fade: n.sliderFadeMode,
            slideDistance:
              "string" != typeof n.slideDistance.size
                ? n.slideDistance.size
                : 0,
            slideAnimationDuration: +n.slideDuration,
            imageScaleMode: "exact",
            waitForLayers: !1,
            grabCursor: !1,
            thumbnailWidth: n.thumbnailWidth,
            thumbnailHeight: n.thumbnailHeight,
            rightToLeft: n.rightToLeft,
            init: function () {
              var t = e("." + n.sliderFullscreenIcon).html(),
                i = e("." + n.sliderNavigationIcon).html();
              e(".sp-full-screen-button", a).html(t),
                e(".sp-previous-arrow", a).html(i),
                e(".sp-next-arrow", a).html(i),
                e(".slider-pro", a).addClass("slider-loaded"),
                this.resize();
            },
            breakpoints: m,
          }),
          e(".slider-pro", a).on("gotoSlide", function () {
            a.find("[data-element_type]").each(function () {
    ...
    widgetTestimonials: function (t) {
      var a = t.find(".jet-testimonials__instance"),
        o = (e(".jet-testimonials__figure", a), a.data("settings"));
      a.length &&
        ((o.adaptiveHeight = o.adaptiveHeight),
        (o.slide = ".jet-testimonials__item"),
        i.initCarousel(a, o));
    },
    ...
    elementorSection: function (e) {
      ...
      (window.jetElements.hasOwnProperty("jetParallaxSections") || a) &&
        new jetSectionParallax(i).init();
    },
    initCarousel: function (t, i) {
      var a, o, n, r;
      (a = i.slidesToShow.tablet
        ? i.slidesToShow.tablet
        : 1 === i.slidesToShow.desktop
        ? 1
        : 2),
        ...
        (n = {
          ...
          responsive: [
            { breakpoint: 1025, settings: { slidesToShow: a } },
            {
              breakpoint: 768,
    ...
    widgetDropbar: function (t) {
      var i,
        a,
        o = t.find(".jet-dropbar"),
        n = o.find(".jet-dropbar__inner"),
        r = o.find(".jet-dropbar__button"),
        s = o.find(".jet-dropbar__content"),
        l = o.data("settings") || {},
        d = l.mode || "hover",
        c = +l.hide_delay || 0,
        u = "jet-dropbar-open";
      "click" === d
        ? r.on("click.jetDropbar", function (e) {
            o.toggleClass(u);
          })
        : "ontouchstart" in window || "ontouchend" in window
        ? r.on("touchend.jetDropbar", function (t) {
        ...
        e(document).on("click.jetDropbar touchend.jetDropbar", function (t) {
          ("touchend" === t.type && e(window).scrollTop() !== i) ||
            e(t.target).closest(r).length ||
            e(t.target).closest(s).length ||
            (o.hasClass(u) && o.removeClass(u));
        });
    },
    widgetVideo: function (e) {
      ...
      function c() {
        ...
        e && i.attr("src", e),
          d || (i[0].src = i[0].src.replace("&autoplay=0", "&autoplay=1")),
          r.remove(),
          (s = !1);
      }
      r[0] &&
        r.on("click.jetVideo", function (e) {
          if (a[0]) return a[0].play(), r.remove(), void (s = !1);
          i[0] && c();
        }),
        d && i[0] && r[0] && c(),
        a[0] &&
          a.on("play.jetVideo", function (e) {
            s && (r.remove(), (s = !1));
          }),
        o[0] &&
    ...
    widgetAudio: function (e) {
      ...
      i[0] &&
        ...
        i.mediaelementplayer({
          ...
          enableProgressTooltip: !1,
          success: function (t) {
            var i = e.find(".mejs-button button");
            t.addEventListener(
              "timeupdate",
              function (t) {
                var i = e.find(".mejs-time-current"),
                    ...
                    function () {
                      var n =
                          "horizontal" === a.audioVolume
                            ? e.find(".mejs-horizontal-volume-current")
                            : e.find(".mejs-volume-current"),
                        s =
                          "horizontal" === a.audioVolume
                            ? parseInt(n[0].style.width, 10) / 100
                            : parseInt(n[0].style.height, 10) / 100,
                        l =
                          "horizontal" === a.audioVolume
                            ? e.find(".mejs-horizontal-volume-total")
                            : e.find(".mejs-volume-slider .mejs-volume-total"),
    ...
    widgetHorizontalTimeline: function (t) {
      var i = t.find(".jet-hor-timeline"),
        ...
        m = f,
        g = t.find(".jet-hor-timeline-list--middle .jet-hor-timeline-item")
          .length,
        h = a.isRTL(),
        v = 0,
        w = 0,
      ...
      function j() {
        var e = t.find(".jet-hor-timeline__line"),
          ...
          r = i.outerWidth();
        e.css({ left: h ? n + r / 2 : o + r / 2, width: Math.abs(n - o) });
      }
      function x() {
        if (r[0]) {
      ...
      "ontouchstart" in window || "ontouchend" in window
        ? n.on("touchend.jetHorTimeline", function (i) {
        ...
        s[0] && 0 === y[f] && s.addClass("jet-arrow-disabled"),
        r[0] &&
          r.on("click.jetHorTimeline", function (t) {
            var i = e(this).hasClass("jet-next-arrow") ? "next" : "prev",
              a = h ? 1 : -1,
              n = elementorFrontend.getCurrentDeviceMode(),
              r = u[n];
            r > c[n] && (r = c[n]),
              "next" === i && w < y[n] && (w += r) > y[n] && (w = y[n]),
              "prev" === i && w > 0 && (w -= r) < 0 && (w = 0),
              w > 0
                ? l.removeClass("jet-arrow-disabled")
                : l.addClass("jet-arrow-disabled"),
              w === y[n]
                ? s.addClass("jet-arrow-disabled")
                : s.removeClass("jet-arrow-disabled"),
              (v = 0 === w ? 0 : w * b[n]),
              o.css({ transform: "translateX(" + a * v + "%)" });
          }),
        x(),
        e(window).on(
          "resize.jetHorTimeline orientationchange.jetHorTimeline",
        ...
        e(window).on(
          ...
          function (e) {
            ...
            var t = elementorFrontend.getCurrentDeviceMode(),
              a = function () {
                l.addClass("jet-arrow-disabled"),
                  s.hasClass("jet-arrow-disabled") &&
                    s.removeClass("jet-arrow-disabled"),
                  0 === y[t] && s.addClass("jet-arrow-disabled"),
                  (v = 0),
                  (w = 0),
    ...
    widgetPieChart: function (t) {
      var a = t.find(".jet-pie-chart-container"),
        ...
        n = a.data("chart") || {},
        r = a.data("options") || {};
      (r = e.extend({}, { maintainAspectRatio: !1 }, r)),
        elementorFrontend.waypoint(
          t,
          function () {
            new Chart(o, { type: "pie", data: n, options: r });
          },
          i.prepareWaypointOptions(t, { offset: "bottom-in-view" })
        );
    },
    ...
    widgetLineChart: function (t) {
      var a = t.data("id"),
        o = t.find(".jet-line-chart-container"),
        n = o.find(".jet-line-chart"),
        r = o.data("compare"),
        s = o.data("previous-label"),
        l = o.data("current-label"),
        d = o.data("settings"),
        c = o.data("compare-labels-type");
      o.length &&
        elementorFrontend.waypoint(
          n,
          function () {
            ...
            (i.options.tooltips = {
              ...
              callbacks: {
                label: function (e, t) {
                  ...
                  if (((i = i.replace(/"/g, '"')), !0 === r)) {
                    var a = "custom" === c ? l : t.labels[e.index],
                      o = t.datasets[e.datasetIndex].label,
                      n =
                        ...
                        "</div>",
                      d = "",
                      u = (u = t.datasets[e.datasetIndex].borderColor).replace(
                        /"/g,
                        '"'
                      );
                    if (
                      ...
                      d =
                        ...
                        ("custom" === c ? s : t.labels[e.index - 1]) +
                        " : " +
                        t.datasets[e.datasetIndex].data[e.index - 1] +
                        "</div>";
                    return (
              ...
              custom: function (e) {
                var t = document.getElementById("chartjs-tooltip_" + a);
                if (
                  (t ||
                  ...
                  if (
                    ...
                    var i = e.body.map(function (e) {
                      ...
                      o = "";
                    (o += '<div class="jet-line-chart-tooltip-wrapper">'),
                      i.forEach(function (e, t) {
                        o += e;
                      }),
                      (o += "</div>"),
                      (t.querySelector("div").innerHTML = o);
                  }
                  var n = this,
                    r = this._chart.canvas.getBoundingClientRect(),
                    s = t.offsetWidth,
                    l = t.offsetHeight,
                    d = 0,
                    c = 0;
                  setTimeout(function () {
                    (s = t.offsetWidth),
                      (l = t.offsetHeight),
                      (d =
                        n._chart.width / 2 > n._chart.tooltip._eventPosition.x
                          ? 0
                          : -s),
                      (c =
                        n._chart.height / 2 > n._chart.tooltip._eventPosition.y
                          ? 0
                          : -l),
                      (t.style.left =
                        r.left + window.pageXOffset + e.caretX + d + "px"),
                      (t.style.top =
                        r.top + window.pageYOffset + e.caretY + c + "px"),
                      (t.style.opacity = 1);
                  }, 10),
                    (t.style.position = "absolute"),
                    (t.style.fontFamily = e._bodyFontFamily),
                    (t.style.fontSize = e.bodyFontSize + "px"),
                    (t.style.fontStyle = e._bodyFontStyle),
                    (t.style.padding = e.yPadding + "px " + e.xPadding + "px"),
    ...
    widgetLottie: function (t) {
      ...
      if (n[0]) {
        (i = {
          ...
          (o = lottie.loadAnimation(i)),
          s.play_speed && o.setSpeed(s.play_speed),
          s.reversed && o.setDirection(-1);
        var l = 0,
          d = 0;
        switch (
          (s.viewport &&
            ((l = -s.viewport.start || 0), (d = -(100 - s.viewport.end) || 0)),
          s.action_start)
        ) {
          case "on_hover":
            var c = !1,
              u = function () {
                if (c && "reverse" === s.on_hover_out) {
                  var e = s.reversed ? -1 : 1;
                  o.setDirection(e);
                }
                o.play(), (c = !0);
              },
              p = function () {
                switch (s.on_hover_out) {
                  case "pause":
                    o.pause();
                    break;
                  case "stop":
            ...
            n.off("mouseenter.JetLottie", u).on("mouseenter.JetLottie", u),
              n.off("mouseleave.JetLottie", p).on("mouseleave.JetLottie", p);
            break;
          case "on_click":
            var f = n.find(".jet-lottie__link"),
              m = +s.redirect_timeout,
              g = function () {
                o.play();
              },
              h = function (t) {
            ...
            f[0] && m > 0
              ? f.off("click.JetLottie", h).on("click.JetLottie", h)
              : n.off("click.JetLottie", g).on("click.JetLottie", g);
            break;
          case "on_viewport":
                ...
                function (e, t) {
                  e[0].isIntersecting
                    ? (v = requestAnimationFrame(function e() {
                        if (window.scrollY !== w) {
                          var t = a.getElementPercentageSeen(r, {
                              start: l,
                              end: d,
                            }),
    ...
    widgetPricingTable: function (t) {
      var i = t.find(".pricing-table"),
        a = e(".pricing-feature .pricing-feature__inner[title]", i),
        o = i.data("tooltips-settings"),
        n = t.find(".pricing-table__fold-mask"),
        r = t.find(".pricing-table__fold-button"),
        s = n,
      ...
      a[0] &&
        a.each(function () {
          ...
          t._tippy && t._tippy.destroy(),
            tippy([t], {
              ...
              arrowType: o.tooltipArrowType,
              arrowTransform: o.tooltipArrowSize,
              duration: [
                o.tooltipShowDuration.size,
                o.tooltipHideDuration.size,
              ],
              distance: o.tooltipDistance.size,
        ...
        d &&
          (t.find(".pricing-table__fold-mask .fold_visible").each(function () {
            c += e(this).outerHeight(!0);
          }),
          h(),
          n.hasClass("pricing-table-unfold-state") || s.css({ height: c }),
          t.find(".pricing-table__fold-mask").css("max-height", "none"),
          r.on("click.jetPricingTable", function () {
            var t = e(this),
  ...
  var a = {
    getElementPercentageSeen: function (t, i) {
      ...
      return (
        (a =
          (e(window).scrollTop() + s + l - t.offset().top) /
          (s + l + d + t.height())),
        (a = Math.min(100, Math.max(0, 100 * a))),
  ...
  (window.jetAnimatedText = function (t, i) {
    var a = this,
      ...
      r = null,
      s = ((i = e.extend({ effect: "fx1", delay: 3e3 }, i || {})), 0),
      l = i.delay;
    (a.avaliableEffects = {
      fx1: {
        in: {
      ...
      (a.textChange = function () {
        ...
        s < n.length - 1 ? s++ : (s = 0),
          (e = n.eq(s)),
          a.hideText(t, i.effect, null, function (o) {
      ...
      (a.hideText = function (t, i, o, n) {
        ...
        e("span", t).each(function () {
          ...
          a.animateText(r, "out", i, o, n);
      }),
      (a.animateText = function (e, t, i, o, n) {
        var r = (a.avaliableEffects[i] || {})[t];
        (r.targets = e), (r.begin = o), (r.complete = n), anime(r);
      }),
      (a.init = function () {
        var e = n.eq(s);
    ...
    (window.jetImagesLayout = function (t, i) {
      var a,
        ...
        n = t,
        r =
          (e(".jet-images-layout__list", n), e(".jet-images-layout__item", n));
      i = i || {};
      (a = {
        layoutType: "masonry",
        columns: 3,
            ...
            case "justify":
              r.each(function () {
                var t = e(this),
                  ...
                  o = +a.data("width") / +a.data("height"),
                  n = 100 * o,
                  r = +i.justifyHeight * o;
                t.css({ "flex-grow": n, "flex-basis": r });
              });
          }
    ...
    (window.jetScrollNavigation = function (t, i, o) {
      var n = this,
        r = e(window),
        s = e(document),
        l = (e("body"), i),
        d = e("html, body"),
        c = e(".jet-scroll-navigation__item", l),
        u =
          ((o = e.extend(
            {},
            {
        ...
        p = null,
        f = !1,
        m = window.location.hash.slice(1),
        g = 0,
        h = navigator.platform;
      jQuery.extend(jQuery.easing, {
        easeInOutCirc: function (e, t, i, a, o) {
          return (t /= o / 2) < 1
            ? (-a / 2) * (Math.sqrt(1 - t * t) - 1) + i
            : (a / 2) * (Math.sqrt(1 - (t -= 2) * t) + 1) + i;
        },
      }),
        (n.init = function () {
          n.setSectionsData(),
            m && u.hasOwnProperty(m) && c.addClass("invert"),
            c.on("click.jetScrollNavigation", function (t) {
              var i = e(this).data("anchor");
              n.onAnchorChange(i);
            }),
            r.on(
              "resize.jetScrollNavigation orientationchange.jetScrollNavigation",
              a.debounce(50, n.onResize)
            ),
            r.on("load", function () {
              n.setSectionsData();
            }),
            s.keydown(function (e) {
              n.isEnabled() &&
                (38 == e.keyCode && n.directionSwitch(e, "up"),
                40 == e.keyCode && n.directionSwitch(e, "down"));
            }),
            n.waypointHandler(),
            n.hijakingHandler();
        }),
        (n.setSectionsData = function () {
          c.each(function () {
            var t = e(this),
              ...
              o = e("#" + i);
            o[0] &&
              (o.addClass("jet-scroll-navigation-section"),
              (o[0].dataset.sectionName = i),
              (u[i] = {
                selector: o,
            ...
            elementorFrontend.waypoint(
              ...
              function (t) {
                ...
                "down" !== t ||
                  ...
                  e("[data-anchor=" + i + "]", l).addClass("active"),
                  c.removeClass("invert"),
                  u[i].invert && c.addClass("invert"));
              },
        ...
        (n.directionSwitch = function (t, i) {
          i = i || "up";
          var a = e("[data-anchor=" + p + "]", l).next(),
            o = e("[data-anchor=" + p + "]", l).prev();
          if (f) return !1;
          "up" === i && o[0] && o.trigger("click.jetScrollNavigation"),
            "down" === i && a[0] && a.trigger("click.jetScrollNavigation");
        }),
        (n.hijakingHandler = function () {
          ...
          o.sectionSwitch &&
            (t ||
              document.addEventListener("wheel", n.onWheel, { passive: !1 }),
            t &&
              o.sectionSwitchOnMobile &&
              ...
              document.addEventListener(
                ...
                function (t) {
                  if (n.isEnabled()) {
                    var o = e(t.target),
                      s = o.closest(".jet-scroll-navigation") || !1,
                      l =
                        (o.closest(".elementor-top-section") || !1).attr(
                          "id"
                        ) || !1,
                      d = r.scrollTop(),
                    ...
                    return (
                      ...
                      void (
                        l &&
                        u.hasOwnProperty(l) &&
                        ((g = a.getObjectPrevKey(u, l)),
                        (h = a.getObjectNextKey(u, l)),
                        (f = u[l].offset),
                        "up" === p && (f - v < d && (g = l), g && (m = g)),
                        "down" === p && (f + v > d && (h = l), h && (m = h)),
                        m && n.onAnchorChange(m))
                      )
                    );
                  }
                },
        ...
        (n.onWheel = function (t) {
          if (n.isEnabled()) {
            f && t.preventDefault();
            var i =
                e(t.target).closest(".elementor-top-section[id]").attr("id") ||
                !1,
            ...
            if (
              i &&
              u.hasOwnProperty(i) &&
              ((c = a.getObjectPrevKey(u, i)),
              (p = a.getObjectNextKey(u, i)),
              (l = u[i].offset),
              "up" === s && (l < m + o.offset - 10 && (c = i), c && (d = c)),
              "down" === s && (l > m + o.offset + 10 && (p = i), p && (d = p)),
              d)
            ) {
              if ((t.preventDefault(), t.timeStamp - g > 10 && "MacIntel" == h))
                return (g = t.timeStamp), !1;
              n.onAnchorChange(d);
            }
            return !1;
          }
    ...
    (window.jetSectionParallax = function (i) {
      ...
      (o.init = function () {
        if (
          !(r = s
            ? o.generateEditorSettings(n)
            : jetElements.jetParallaxSections[n] || !1)
        )
          return !1;
        o.generateLayouts(),
          0 !== d.length &&
          ...
          0 !== c.length &&
            ...
            i.on("mouseleave.jetSectionParallax", o.mouseLeaveHandler)),
          o.scrollUpdate();
      }),
        (o.generateEditorSettings = function (t) {
          ...
          return (
            ...
            !(
              !o.hasOwnProperty("jet_parallax_layout_list") ||
              0 === Object.keys(o).length
            ) &&
              ((a = o.jet_parallax_layout_list.models),
        ...
        (o.generateLayouts = function () {
          e(".jet-parallax-section__layout", i).remove(),
            e.each(r, function (t, o) {
              var n,
                r,
                s = o.jet_parallax_layout_image,
                l = o.jet_parallax_layout_speed.size || 50,
                u = o.jet_parallax_layout_z_index,
                p = o.jet_parallax_layout_bg_size || "auto",
                f = o.jet_parallax_layout_animation_prop || "bgposition",
                m = o.jet_parallax_layout_bg_x,
                h = o.jet_parallax_layout_bg_y,
                v = o.jet_parallax_layout_type || "none",
                w = o.jet_parallax_layout_direction || "1",
                b = o.jet_parallax_layout_fx_direction || "fade-in",
                y = o.jet_parallax_layout_on || ["desktop", "tablet"],
                j = o._id,
                x =
                  o.hasOwnProperty("__dynamic__") &&
                  o.__dynamic__.hasOwnProperty("jet_parallax_layout_image"),
                _ = "MacIntel" == g ? " is-mac" : "";
              if ("" === s.url && !x) return !1;
              ...
              "" !== s.url && (k["background-image"] = "url(" + s.url + ")"),
                e("> .jet-parallax-section__image", n).css(k),
                (r = {
                  selector: n,
                  image: s.url,
                  size: p,
            ...
            switch (
              ...
              case "scroll":
                "bgposition" === l
                  ...
                  : o.css({ transform: "translateY(" + m + "px)" });
                break;
              case "h-scroll":
                "bgposition" === l
                  ? o.css({
                  ...
                  : o.css({ transform: "translateX(" + m * c + "px)" });
                break;
              case "zoom":
                var h = ((u - r + p) / p) * n;
                (h += 1), o.css({ transform: "scale(" + h + ")" });
                break;
              case "rotate":
                var v = m;
                o.css({ transform: "rotateZ(" + v * c + "deg)" });
                break;
              case "blur":
                var w = 0;
                switch (f) {
        ...
        (o.mouseMoveHandler = function (e) {
          var t = l.width(),
            ...
            r = e.clientX - a,
            s = e.clientY - n;
          (f = (r / a) * -1), (m = (s / n) * -1), o.mouseMoveUpdate();
        }),
          ...
          e.each(c, function (t, i) {
            ...
            switch (r) {
              case "bgposition":
                ...
                break;
              case "transform":
                TweenMax.to(o[0], 1, { x: s, y: l, ease: Power2.easeOut });
                break;
              case "transform3d":
                TweenMax.to(o[0], 2, {
                  x: s,
    ...
    (window.jetPortfolio = function (t, i) {
      var o,
        ...
        m = {},
        g = "all",
        h = { itemSelector: ".jet-portfolio__item", percentPosition: !0 };
      i = e.extend(
        {
          layoutType: "masonry",
          columns: 3,
      ...
      (n.init = function () {
        ...
        (n.layoutBuild = function () {
          if (
            (n.generateData(),
            d.data("showItems", p ? i.perPage : "all"),
            "justify" == i.layoutType && (h.columnWidth = ".grid-sizer"),
            ("masonry" != i.layoutType && "justify" != i.layoutType) ||
              (o = s.masonry(h)),
            e.isFunction(e.fn.imagesLoaded))
          )
            e(".jet-portfolio__image", l)
              .imagesLoaded()
              .progress(function (t, i) {
                var a = e(i.img).closest(".jet-portfolio__item");
                e(".jet-portfolio__image-loader", a).remove(),
                  a.addClass("item-loaded"),
                  o && o.masonry("layout");
              });
          else {
          ...
          d.on("click.jetPortfolio", n.filterHandler),
            u.on("click.jetPortfolio", n.moreButtonHandler),
            n.render(),
            n.checkMoreButton();
        }),
        (n.generateData = function () {
          d[0]
            ? d.each(function (t) {
        ...
        (n.filterHandler = function (t) {
          var i = e(this),
            a = 1,
            o = i.data("slug"),
            r = i.data("showItems");
          for (var s in (d.removeClass("active"), i.addClass("active"), m))
            (m[s] = !1), s == o && ((m[s] = !0), (g = s));
          e.each(f, function (e, t) {
            var i = !1;
            "all" === r
              ? n.isItemVisible(t.slug) && !t.more && (i = !0)
              : n.isItemVisible(t.slug) &&
                (a <= r ? ((i = !0), (t.more = !1)) : (t.more = !0), a++),
              (t.visible = i);
          }),
            n.render(),
            n.checkMoreButton();
        }),
        (n.moreButtonHandler = function (t) {
          e(this);
          var a,
            o = 1,
          ...
          e.each(f, function (e, t) {
            ...
            s[0] && ((a = s.data("showItems")), s.data("showItems", a + o - 1)),
            n.render(),
            n.checkMoreButton();
        }),
        (n.checkMoreButton = function () {
          var t = !1;
          e.each(f, function (e, i) {
            n.isItemVisible(i.slug) && i.more && (t = !0);
          }),
            t ? c.removeClass("hidden-status") : c.addClass("hidden-status");
        }),
        (n.isItemVisible = function (e) {
        ...
        (n.anyFilterEnabled = function () {
          for (var e in m) if (m[e]) return !0;
          return !1;
        }),
        (n.render = function () {
          l.removeClass("visible-status").removeClass("hidden-status"),
            e.each(f, function (t, a) {
              var o = e(".jet-portfolio__inner", a.selector),
                n = e(".jet-portfolio__link", a.selector),
                r = i.id + "-" + g;
              a.visible
                ? (a.selector.addClass("visible-status"),
                  a.lightboxEnabled &&
                    n[0].setAttribute("data-elementor-lightbox-slideshow", r),
                  anime({
                    targets: o[0],
                ...
                : (a.selector.addClass("hidden-status"),
                  n[0].removeAttribute("data-elementor-lightbox-slideshow"),
                  anime({
                    targets: o[0],
                    opacity: 0,
                    scale: 0,
    ...
    (window.jetTimeLine = function (t) {
      var i = t.closest(
        ...
        o = !!i[0],
        n = o ? i : e(window),
        r = o ? n.offset().top - e(window).scrollTop() : 0,
        s = this,
      ...
      (s.onScroll = function () {
        ...
        (s.updateWindow = function () {
          (h = !1),
            ...
            f !== p && ((f = p), m, s.updateProgress());
        }),
        (s.updateProgress = function () {
          var t = c.last().find(u).offset().top,
            i = o ? t + p - r - e(window).scrollTop() : t,
            a = o
              ? d.offset().top + p - r - e(window).scrollTop()
              : d.offset().top,
            n = p - a + g / 2;
          i <= p + g / 2 && (n = i - a),
            d.css({ height: n + "px" }),
            c.each(function () {
              ...
              (t = o ? t + p - r - e(window).scrollTop() : t) < p + 0.5 * g
                ? e(this).addClass("is--active")
                : e(this).removeClass("is--active");
            });
        }),
        (s.updateFrame = function () {
          h || requestAnimationFrame(s.updateWindow), (h = !0);
        }),
        (s.animateCards = function () {
          c.each(function () {
            var t = e(this).offset().top;
            (t = o ? t + p - r - e(window).scrollTop() : t) <= p + 0.9 * g &&
              e(this).hasClass("jet-timeline-item--animated") &&
              e(this).addClass("is--show");
          });
        }),
        (s.init = function () {
          e(document).ready(s.onScroll),
            n.on("scroll.jetTimeline", s.onScroll),
            e(window).on(
              "resize.jetTimeline orientationchange.jetTimeline",
              a.debounce(50, s.onResize)
            );
        });
    }),
    (window.jetScratchEffect = function (e, t, i) {
      ...
      function f(e) {
        if (c) {
          ...
          for (
            ...
            (g = o.x + Math.sin(m) * v - 40),
              (h = o.y + Math.cos(m) * v - 40),
              (l.globalCompositeOperation = "destination-out"),
              l.drawImage(d, g, h, 80, 80);
          (o = p),
            ((function (e) {
              (!e || e < 1) && (e = 1);
              for (
                var t = l.getImageData(0, 0, r, s).data,
                  i = t.length,
                  a = i / e,
                  o = 0,
                  n = (o = 0);
      ...
      (d.src =
        ...
        n.addEventListener("mousemove", a.debounce(5, f), !1),
        n.addEventListener("mouseup", m, !1),
        n.addEventListener("touchstart", p, !1),
        n.addEventListener("touchmove", f, !1),
        n.addEventListener("touchend", m, !1);
    });
