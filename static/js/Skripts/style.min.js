...
!(function () {
    ...
    if (0 < n.length)
      for (var s = 0; s < n.length; s++)
        "DIV" == n[s].tagName &&
          ...
          (a < t
            ? (null != l[s] && l[s].classList.remove("toggled"),
  ...
  e(),
    (AstraToggleSubMenu = function () {
      ...
      if (
        e.classList.contains("ast-submenu-expanded") &&
        document
      ...
      for (
        var a = e.querySelectorAll(".menu-item-has-children"), n = 0;
        n < a.length;
        n++
      ) {
      ...
      e.classList.contains("menu-item-has-children") &&
        (astraToggleClass(e, "ast-submenu-expanded"),
        e.classList.contains("ast-submenu-expanded")
          ? (e.querySelector(".sub-menu").style.display = "block")
          : (e.querySelector(".sub-menu").style.display = "none"));
    }),
    ...
    (AstraToggleSetup = function () {
      ...
      if (0 < l.length)
        for (var t = 0; t < l.length; t++)
          if (
            (l[t].setAttribute("data-index", t),
            s[t] ||
              ((s[t] = l[t]),
              l[t].addEventListener("click", astraNavMenuToggle, !1)),
            void 0 !== e[t])
          ) {
            if (
              document
              ...
              a = e[t].querySelectorAll("ul.main-header-menu .ast-menu-toggle");
            if (0 < a.length)
              for (var n = 0; n < a.length; n++)
                a[n].addEventListener("click", AstraToggleSubMenu, !1);
          }
    }),
    (astraNavMenuToggle = function (e) {
      ...
      for (
        var n = t[a].querySelectorAll(".menu-item-has-children"), s = 0;
        s < n.length;
        s++
      ) {
        n[s].classList.remove("ast-submenu-expanded");
        for (
          var o = n[s].querySelectorAll(".sub-menu"), r = 0;
          r < o.length;
          r++
        )
      ...
      -1 !==
        ...
        (astraToggleClass(t[a], "toggle-on"),
        astraToggleClass(l[a], "toggled"),
        t[a].classList.contains("toggle-on")
    ...
    /trident/i.test(n[1])
      ? (t = /\brv[ :]+(\d+)/g.exec(a) || [])
      : ("Chrome" === n[1] && null != (t = a.match(/\bOPR|Edge\/(\d+)/))) ||
        ((n = n[2]
          ? [n[1], n[2]]
          : [navigator.appName, navigator.appVersion, "-?"]),
        null != (t = a.match(/version\/(\d+)/i)) && n.splice(1, 1, t[1]),
        (bodyElement = document.body),
        "Safari" === n[0] &&
          n[1] < 11 &&
          bodyElement.classList.add("ast-safari-browser-less-than-11"));
  for (
    var o = document.getElementsByClassName("astra-search-icon"), r = 0;
    r < o.length;
    r++
  )
    o[r].onclick = function (e) {
      if (this.classList.contains("slide-search")) {
        e.preventDefault();
        var t = this.parentNode.parentNode.parentNode.querySelector(
          ".ast-search-menu-icon"
        );
        t.classList.contains("ast-dropdown-active")
  ...
  function i(e) {
    if (
      e &&
      ((button = e.getElementsByTagName("button")[0]),
      "undefined" != typeof button ||
        ((button = e.getElementsByTagName("a")[0]),
        "undefined" != typeof button))
    )
      if (
        ((menu = e.getElementsByTagName("ul")[0]), "undefined" != typeof menu)
      ) {
        for (
          ...
          subMenus[r].parentNode.setAttribute("aria-haspopup", "true");
        for (r = 0, len = links.length; r < len; r++)
          links[r].addEventListener("focus", d, !0),
            links[r].addEventListener("blur", u, !0),
            links[r].addEventListener("click", c, !0);
    ...
    if (
      ...
      if (
        ...
        r &&
          l &&
          i &&
          (r.classList.remove("toggled"),
          l.classList.remove("toggle-on"),
