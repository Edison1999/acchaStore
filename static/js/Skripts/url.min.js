  ...
  (this.wp.url = (function (e) {
                    ...
                    for (r = 0; r < s.length; ++r)
                      if (r !== f) {
                        ...
                        -1 === b
                          ...
                          : ((d = t.decoder(h.slice(0, b), i.decoder, p)),
                            (y = t.decoder(h.slice(b + 1), i.decoder, p))),
                          y &&
    ...
    444: function (e, t, r) {
      ...
      function g() {
        ...
        return (
          -1 !== n &&
            ((t = Object.assign(Object(b.parse)(e.substr(n + 1)), t)),
            (r = r.substr(0, n))),
          r + "?" + Object(b.stringify)(t)
        );
      }
      function v(e, t) {
        var r = e.indexOf("?");
      ...
      function j(e) {
        for (
          var t = e.indexOf("?"),
            r = -1 !== t ? Object(b.parse)(e.substr(t + 1)) : {},
