...
!(function (e, t) {
  ...
  return function (p, i, e, t) {
    ...
    function d(e, t) {
      if (!y.loop && t) {
        var n = Y + (Ve.x * Ge - e) / Ve.x,
          i = Math.round(e - wt.x);
        ((n < 0 && 0 < i) || (n >= Gt() - 1 && i < 0)) &&
          (e = wt.x + i * y.mainScrollEndFriction);
      }
      (wt.x = e), nt(e, W);
    }
    function u(e, t) {
    ...
    function l(e) {
      e && (Me || Te || Ze || be) && (e.preventDefault(), e.stopPropagation());
    }
    function D() {
    ...
    function O(e, t) {
      return (
        (Mt.prevent = !Tt(e.target, y.isClickableElement)),
        x("preventDragEvent", e, t, Mt),
        Mt.prevent
      );
    }
    function k(e, t) {
    ...
    function Z(e) {
      ...
      return (
        le
          ...
          ? e.touches &&
            0 < e.touches.length &&
            ((Et[0] = k(e.touches[0], St)),
            1 < e.touches.length && (Et[1] = k(e.touches[1], At)))
          : ((St.x = e.pageX), (St.y = e.pageY), (St.id = ""), (Et[0] = St)),
        Et
      );
    }
    function F(e, t) {
      var n,
        ...
        u = wt.x - ft.x;
      if (
        ((n = r > Re.min[e] || r < Re.max[e] ? y.panEndFriction : 1),
        (r = We[e] + t[e] * n),
        (y.allowPanToNext || K === h.currItem.initialZoomLevel) &&
          (Pe
            ? "h" !== Fe ||
              "x" !== e ||
              Te ||
              (l
                ? (r > Re.min[e] &&
                    ...
                    (i = Re.min[e] - Ye[e])),
                  (i <= 0 || u < 0) && 1 < Gt()
                    ? ((a = s), u < 0 && s > ft.x && (a = ft.x))
                    : Re.min.x !== Re.max.x && (o = r))
                : (r < Re.max[e] &&
                    ((n = y.panEndFriction),
                    Re.max[e],
                    (i = Ye[e] - Re.max[e])),
                  (i <= 0 || 0 < u) && 1 < Gt()
                    ? ((a = s), 0 < u && s < ft.x && (a = ft.x))
                    : Re.min.x !== Re.max.x && (o = r)))
            : (a = s),
          "x" === e))
      )
        return (
          a !== undefined && (d(a, !0), (Ae = a !== ft.x)),
          Re.min.x !== Re.max.x &&
            (o !== undefined ? (We.x = o) : Ae || (We.x += t.x * n)),
          a !== undefined
        );
      Ze || Ae || (K > h.currItem.fitRatio && (We[e] += t[e] * n));
    }
    function L(e) {
    ...
    function _(e) {
      ...
      if ((x("pointerUp"), O(e, !1) && e.preventDefault(), le)) {
        var n = f.arraySearch(pt, e.pointerId, "id");
        -1 < n &&
          ((t = pt.splice(n, 1)[0]),
      ...
      if (
        ...
        Oe &&
          a < 2 &&
          ((Oe = !1), 1 === a && (i = "zoomPointerUp"), x("zoomGestureEnded")),
        (Ee = null),
        Me || Te || Ze || be)
      )
        if ((S(), ge || (ge = kt()), ge.calculateSwipeSpeed("x"), be))
          if (P() < y.verticalDragRange) h.close();
          else {
            var l = We.y,
              s = _e;
            A("verticalDrag", 0, 1, 300, f.easing.cubic.out, function (e) {
              (We.y = (h.currItem.initialPosition.y - l) * e + l),
                v((1 - s) * e + s),
                et();
            }),
              x("onVerticalDrag", 1);
          ...
          Ze ||
            ("swipe" === i ? !Ae && K > h.currItem.fitRatio && Rt(ge) : Ft());
        }
    }
    var N,
      U,
      ...
      et = function (e) {
        Pe &&
          (e &&
            (K > h.currItem.fitRatio
              ? Je || (jt(h.currItem, !1, !0), (Je = !0))
              : Je && (jt(h.currItem), (Je = !1))),
          o(Pe, We.x, We.y, K));
      },
      tt = function (e) {
        e.container &&
      ...
      ot = function () {
        it &&
          (f.unbind(document, "mousemove", ot),
          f.addClass(p, "pswp--has_mouse"),
          (y.mouseUsed = !0),
          x("mouseUsed")),
      ...
      lt = {
        ...
        init: function () {
          if (!N && !U) {
            ...
            (h.framework = f),
              (h.template = p),
              (h.bg = f.getChildByClass(p, "pswp__bg")),
              (de = p.className),
              (N = !0),
              (he = f.detectFeatures()),
              (ue = he.raf),
              ...
              (re = he.transform),
              (pe = he.oldIE),
              (h.scrollWrap = f.getChildByClass(p, "pswp__scroll-wrap")),
            ...
            for (
              (he.animationName && he.transform && !t) ||
            ...
            i && (h.ui = new i(h, f)).init(),
              x("firstUpdate"),
              (Y = Y || y.index || 0),
              (isNaN(Y) || Y < 0 || Y >= Gt()) && (Y = 0),
              (h.currItem = Bt(Y)),
              (he.isOldIOSPhone || he.isOldAndroid) && (qe = !1),
              p.setAttribute("aria-hidden", "false"),
              y.modal &&
                (qe
                  ? (p.style.position = "fixed")
                  : ((p.style.position = "absolute"),
                    (p.style.top = f.getScrollY() + "px"))),
              fe === undefined &&
                (x("initialLayout"), (fe = me = f.getScrollY()));
            var n = "pswp--open ";
            for (
              y.mainClass && (n += y.mainClass + " "),
                y.showHideOpacity && (n += "pswp--animate_opacity "),
                n += se ? "pswp--touch" : "pswp--notouch",
                n += he.animationName ? " pswp--css_animation" : "",
                n += he.svg ? " pswp--svg" : "",
                f.addClass(p, n),
                h.updateSize(),
                B = -1,
              ...
              nt((e + B) * Ve.x, ee[e].el.style);
            pe || f.bind(h.scrollWrap, X, h),
              a("initialZoomInEnd", function () {
                h.setContent(ee[0], Y - 1),
                  h.setContent(ee[2], Y + 1),
                  (ee[0].el.style.display = ee[2].el.style.display = "block"),
                  y.focus && p.focus(),
                  f.bind(document, "keydown", h),
                  he.transform && f.bind(h.scrollWrap, "click", h),
                  y.mouseUsed || f.bind(document, "mousemove", ot),
        ...
        close: function () {
          N &&
            ...
            f.unbind(document, "mousemove", ot),
            he.transform && f.unbind(h.scrollWrap, "click", h),
            Ce && f.unbind(window, G, h),
            clearTimeout(ye),
            x("unbindEvents"),
            Xt(h.currItem, null, !0, h.destroy));
        },
        destroy: function () {
          x("destroy"),
            Ut && clearTimeout(Ut),
        ...
        panTo: function (e, t, n) {
          n ||
            (e > Re.min.x ? (e = Re.min.x) : e < Re.max.x && (e = Re.max.x),
            t > Re.min.y ? (t = Re.min.y) : t < Re.max.y && (t = Re.max.y)),
            (We.x = e),
            (We.y = t),
            et();
        },
        ...
        updateCurrZoomItem: function (e) {
          if ((e && x("beforeChange", 0), ee[1].el.children.length)) {
            ...
            Pe = f.hasClass(t, "pswp__zoom-wrap") ? t.style : null;
          } else Pe = null;
          (Re = h.currItem.bounds),
            (q = K = h.currItem.initialZoomLevel),
            (We.x = Re.center.x),
            (We.y = Re.center.y),
            e && x("afterChange");
        },
        invalidateCurrItems: function () {
          Q = !0;
          for (var e = 0; e < 3; e++)
            ee[e].item && (ee[e].item.needsUpdate = !0);
        },
            ...
            if (!(e && n < 2)) {
              ...
              for (var i = 0; i < n; i++)
                0 < Ke
                  ? ((t = ee.shift()),
                    (ee[2] = t),
                    nt((++B + 2) * Ve.x, t.el.style),
                    h.setContent(t, Y - n + i + 1 + 1))
                  : ((t = ee.pop()),
                    ee.unshift(t),
                    nt(--B * Ve.x, t.el.style),
                    h.setContent(t, Y + n - i - 1 - 1));
              if (Pe && 1 === Math.abs(Ke)) {
                var o = Bt(te);
        ...
        updateSize: function (e) {
          if (!qe && y.modal) {
            ...
            (je.x = window.innerWidth),
              ...
              (p.style.height = je.y + "px");
          }
          if (
            ((Be.x = h.scrollWrap.clientWidth),
            (Be.y = h.scrollWrap.clientHeight),
            D(),
            (Ve.x = Be.x + Math.round(Be.x * y.spacing)),
            (Ve.y = Be.y),
            d(Ve.x * Ge),
            x("beforeResize"),
            B !== undefined)
            ...
            for (var n, i, o, a = 0; a < 3; a++)
              (n = ee[a]),
                nt((a + B) * Ve.x, n.el.style),
                (o = Y + a - 1),
                y.loop && 2 < Gt() && (o = s(o)),
                (i = Bt(o)) && (Q || i.needsUpdate || !i.bounds)
                  ? (h.cleanSlide(i),
                    h.setContent(n, o),
                    1 === a && ((h.currItem = i), h.updateCurrZoomItem(!0)),
                    (i.needsUpdate = !1))
                  : -1 === n.index && 0 <= o && h.setContent(n, o),
                i && i.container && ($t(i, Be), jt(i), tt(i));
            Q = !1;
          }
          (q = K = h.currItem.initialZoomLevel),
            (Re = h.currItem.bounds) &&
              ((We.x = Re.center.x), (We.y = Re.center.y), et(!0)),
            x("resize");
        },
            ...
            if (
              ...
              n >
                h.currItem.initialZoomLevel +
                  h.currItem.initialZoomLevel / 15 && (Ne = !0);
              var i = 1,
                o = b(),
                a = I();
              if (n < o)
              ...
              if (
                (Le &&
                  ((Le = !1),
                  10 <= Math.abs(ct.x) && (ct.x -= Ee[0].x - mt.x),
                  10 <= Math.abs(ct.y) && (ct.y -= Ee[0].y - mt.y)),
                (dt.x = st.x),
                (dt.y = st.y),
                0 === ct.x && 0 === ct.y)
              )
        ...
        var t,
          ...
          i = {
            ...
            calculateOverBoundsAnimOffset: function (t, e) {
              i.backAnimStarted[t] ||
                (We[t] > Re.min[t]
                  ? (i.backAnimDestination[t] = Re.min[t])
                  : We[t] < Re.max[t] && (i.backAnimDestination[t] = Re.max[t]),
            ...
            calculateAnimOffset: function (e) {
              i.backAnimStarted[e] ||
                ...
                (i.distanceOffset[e] =
                  ...
                  i.speedDecelerationRatio[e] *
                  i.timeDiff),
                (We[e] += i.distanceOffset[e]));
            },
            panAnimLoop: function () {
              if (
                at.zoomPan &&
                ((at.zoomPan.raf = ue(i.panAnimLoop)),
                (i.now = c()),
      ...
      Pt = function (e, t) {
        ...
        i &&
          ((Y += i) < 0
            ? ((Y = y.loop ? Gt() - 1 : 0), (o = !0))
            : Y >= Gt() && ((Y = y.loop ? 0 : Gt() - 1), (o = !0)),
          (o && !y.loop) || ((Ke += i), (Ge -= i), (n = !0)));
        var l,
          s = Ve.x * Ge,
          u = Math.abs(s - wt.x);
        return (
          (l =
            n || s > wt.x == 0 < t.lastFlickSpeed.x
              ? ((l =
          ...
          A("mainScroll", wt.x, s, l, f.easing.cubic.out, d, function () {
            S(),
              (Ze = !1),
              (xt = -1),
              (!n && xt === Y) || h.updateCurrItem(),
    ...
    n("Gestures", {
      publicMethods: {
        initGestures: function () {
          ...
          (le = he.pointerEvent) && he.touch && (he.touch = !1),
            le
              ? navigator.msPointerEnabled
                ? e("MSPointer", "Down", "Move", "Up", "Cancel")
                : e("pointer", "down", "move", "up", "cancel")
              : he.touch
              ? (e("touch", "start", "move", "end", "cancel"), (se = !0))
    ...
    function Nt() {
      if (Kt.length) {
        for (var e, t = 0; t < Kt.length; t++)
          (e = Kt[t]).holder.index === e.index &&
            Lt(e.index, e.item, e.baseDiv, e.img, 0, e.clearPlaceholder);
        Kt = [];
      }
    }
    var Ut,
      ...
      Xt = function (r, e, l, t) {
        ...
        Ut && clearTimeout(Ut),
          ...
          r.initialLayout
            ...
            : (s = y.getThumbBoundsFn && y.getThumbBoundsFn(Y));
        var c,
          d,
          m = l ? y.hideAnimationDuration : y.showAnimationDuration;
        if (!m || !s || s.x === undefined)
          return (
            x("initialZoom" + (l ? "Out" : "In")),
            (K = r.initialZoomLevel),
            g(We, r.initialPosition),
            et(),
            (p.style.opacity = l ? 0 : 1),
            v(1),
            void (m
              ? setTimeout(function () {
                  u();
        ...
        (c = H),
          (d = !h.currItem.src || h.currItem.loadError || y.showHideOpacity),
          ...
          l ||
            ...
            et()),
          M("initialZoom"),
          l && !c && f.removeClass(p, "pswp--animated-in"),
          d &&
            (l
              ? f[(c ? "remove" : "add") + "Class"](p, "pswp--animate_opacity")
              : setTimeout(function () {
            ...
            function () {
              if ((x("initialZoom" + (l ? "Out" : "In")), l)) {
                var t = s.w / r.w,
                  ...
                  e = function (e) {
                    1 === e
                      ? ((K = t), (We.x = s.x), (We.y = s.y - fe))
                      : ((K = (t - o) * e + o),
                        (We.x = (s.x - n) * e + n),
                        (We.y = (s.y - fe - i) * e + i)),
                      et(),
                      d ? (p.style.opacity = 1 - e) : v(a - e * a);
                  };
                c
                  ? A("initialZoom", 0, 1, m, f.easing.cubic.out, e, u)
                  : (e(1), (Ut = setTimeout(u, m + 20)));
              } else
                (K = r.initialZoomLevel),
                  g(We, r.initialPosition),
                  et(),
                  v(1),
                  d ? (p.style.opacity = 1) : v(1),
                  (Ut = setTimeout(u, m + 20));
            },
            l ? 25 : 90
          ));
      },
    ...
    n("Controller", {
      publicMethods: {
          ...
          f.extend(y, qt, !0),
            ...
            a("initialLayout", function () {
              h.currItem.initialLayout =
                y.getThumbBoundsFn && y.getThumbBoundsFn(Y);
            }),
            a("mainScrollAnimComplete", Nt),
            a("initialZoomInEnd", Nt),
            a("destroy", function () {
        ...
        getItemAt: function (e) {
          return 0 <= e && Ht[e] !== undefined && Ht[e];
        },
        ...
        setContent: function (t, n) {
          ...
          if (o) {
                    ...
                    if (t && t.index === n) {
                      if (_t(e, !0))
                        return (
                          ...
                          $t(e, Be),
                          tt(e),
                          void (t.index === Y && h.updateCurrZoomItem())
                        );
                      e.imageAppended
                        ? !Wt &&
                          e.placeholder &&
            ...
            Yt || n !== Y ? tt(o) : ((Pe = a.style), Xt(o, i || o.img)),
              (t.el.innerHTML = ""),
              t.el.appendChild(a);
          } else t.el.innerHTML = "";
        },
      ...
      n("DesktopZoom", {
        publicMethods: {
          ...
          setupDesktopZoom: function (e) {
            ...
            function n() {
              h.mouseZoomedIn &&
                (f.removeClass(p, "pswp--zoomed-in"), (h.mouseZoomedIn = !1)),
                K < 1
                  ? f.addClass(p, "pswp--zoom-allowed")
                  : f.removeClass(p, "pswp--zoom-allowed"),
                o();
            }
            a("bindEvents", function () {
              f.bind(p, t, h.handleMouseWheel);
            }),
              a("unbindEvents", function () {
                en && f.unbind(p, t, h.handleMouseWheel);
              }),
              (h.mouseZoomedIn = !1);
            var i,
              o = function () {
                i && (f.removeClass(p, "pswp--dragging"), (i = !1));
              };
            a("resize", n),
              a("afterChange", n),
              a("pointerDown", function () {
                h.mouseZoomedIn && ((i = !0), f.addClass(p, "pswp--dragging"));
              }),
              a("pointerUp", o),
              e || n();
          },
          handleMouseWheel: function (e) {
            if (K <= h.currItem.fitRatio)
              return (
                y.modal &&
                  (!y.closeOnScroll || rt || Ce
                    ? e.preventDefault()
                    : re && 2 < Math.abs(e.deltaY) && ((H = !0), h.close())),
                !0
              );
    ...
    var rn,
      ...
      gn = function () {
        if ((sn && clearTimeout(sn), rt || Ce)) sn = setTimeout(gn, 500);
          ...
          var n = mn + "&gid=" + y.galleryUID + "&pid=" + e;
          pn || (-1 === yn.hash.indexOf(n) && (hn = !0));
    ...
    n("History", {
      publicMethods: {
        ...
        onHashChange: function () {
          if (nn() === mn) return (fn = !0), void h.close();
          un || ((cn = !0), h.goTo(an().pid), (cn = !1));
        },
        updateURL: function () {
          on(), cn || (pn ? (rn = setTimeout(gn, 800)) : gn());
        },
      },
    }),
      f.extend(h, lt);
