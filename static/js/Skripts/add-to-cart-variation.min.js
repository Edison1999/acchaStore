  ...
  (t.prototype.onReset = function (t) {
    ...
    (t.prototype.onAddToCart = function (t) {
      y(this).is(".disabled") &&
        ...
        y(this).is(".wc-variation-is-unavailable")
          ...
          : y(this).is(".wc-variation-selection-needed") &&
            c.alert(
    ...
    (t.prototype.onFoundVariation = function (t, a) {
      ...
      a.sku ? e.wc_set_content(a.sku) : e.wc_reset_content(),
        ...
        a.dimensions
          ? o.wc_set_content(y.parseHTML(a.dimensions_html)[0].data)
          : o.wc_reset_content(),
          ...
          : ((c = n.find("input.qty")),
            ...
            (t =
              ...
              (t = t > parseFloat(a.max_qty) ? a.max_qty : t) <
                ...
                ? a.min_qty
                : t),
            c.attr("min", a.min_qty).attr("max", a.max_qty).val(t).change(),
            n.show()),
        (a.is_purchasable && a.is_in_stock && a.variation_is_visible) ||
          (s = !1),
        (y.trim(i.$singleVariation.text())
        ...
        (b.$attributeFields.each(function (t, a) {
          ...
          i.data("attribute_html") ||
            ((_ = i.clone())
              ...
              .removeAttr("selected"),
            i.data("attribute_options", _.find("option" + o).get()),
            i.data("attribute_html", _.html())),
            n.html(i.data("attribute_html"));
          var _ = y.extend(!0, {}, $);
          _[e] = "";
          var d,
            m = b.findMatchingVariations(b.variationData, _);
          for (d in m)
            if ("undefined" != typeof m[d]) {
              var l,
                v = m[d].attributes;
              for (l in v)
                if (v.hasOwnProperty(l)) {
                  var g = v[l],
                    u = "";
                  if (l === e)
                    if ((m[d].variation_is_active && (u = "enabled"), g)) {
                      g = y("<div/>").html(g).text();
                      var f = n.find("option");
                      if (f.length)
                        for (var h = 0, p = f.length; h < p; h++) {
                          var w = y(f[h]);
                          if (g === w.val()) {
                            w.addClass("attached " + u);
                            break;
                          }
                        }
                    } else n.find("option:gt(0)").addClass("attached " + u);
                }
            }
          (a = n.find("option.attached").length),
            ...
            i.html(n.html()),
            i.find("option" + o + ":not(.enabled)").prop("disabled", !0),
            s ? (c ? i.val(s) : i.val("").change()) : i.val("");
        }),
