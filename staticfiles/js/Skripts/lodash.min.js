...
(function () {
  ...
  var Y,
    ...
    Nr = -1,
    Pr = {};
  (Pr[ot] = Pr[ft] = Pr[ct] = Pr[at] = Pr[lt] = Pr[st] = Pr[ht] = Pr[pt] = Pr[
    _t
  ] = !0),
    (Pr[Bn] = Pr[Tn] = Pr[ut] = Pr[Dn] = Pr[it] = Pr[Mn] = Pr[Nn] = Pr[Pn] = Pr[
      Zn
    ] = Pr[Kn] = Pr[Gn] = Pr[Yn] = Pr[Qn] = Pr[Xn] = Pr[rt] = !1);
  var qr = {};
  (qr[Bn] = qr[Tn] = qr[ut] = qr[it] = qr[Dn] = qr[Mn] = qr[ot] = qr[ft] = qr[
    ct
  ] = qr[at] = qr[lt] = qr[Zn] = qr[Kn] = qr[Gn] = qr[Yn] = qr[Qn] = qr[
    Xn
  ] = qr[nt] = qr[st] = qr[ht] = qr[pt] = qr[_t] = !0),
    (qr[Nn] = qr[Pn] = qr[rt] = !1);
  var Zr = {
      "\xc0": "A",
      "\xc1": "A",
