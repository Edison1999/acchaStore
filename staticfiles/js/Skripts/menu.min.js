  ...
  return o.widget("ui.menu", {
        ...
        this._on({
            ...
            !this.mouseHandled &&
              ...
              t.has(".ui-menu").length
                ...
                : !this.element.is(":focus") &&
                  o(this.document[0].activeElement).closest(".ui-menu")
                    .length &&
          ...
          blur: function (e) {
            this._delay(function () {
              o.contains(this.element[0], this.document[0].activeElement) ||
                this.collapseAll(e);
            });
          },
          keydown: "_keydown",
    ...
    refresh: function () {
      ...
      this.element.toggleClass(
        ...
        this.active &&
          !o.contains(this.element[0], this.active[0]) &&
          this.blur();
    },
    _itemRole: function () {
    ...
    collapseAll: function (t, i) {
      clearTimeout(this.timer),
        (this.timer = this._delay(function () {
          var e = i
            ? this.element
            : o(t && t.target).closest(this.element.find(".ui-menu"));
