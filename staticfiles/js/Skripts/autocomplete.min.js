    ...
    u.widget("ui.autocomplete", {
      ...
      _create: function () {
        var i,
          ...
          o = "input" === e;
        (this.isMultiLine =
          t || (!o && this.element.prop("isContentEditable"))),
          ...
          this._on(this.menu.element, {
            mousedown: function (e) {
              ...
              u(e.target).closest(".ui-menu-item").length ||
                this._delay(function () {
                  var t = this;
                  this.document.one("mousedown", function (e) {
                    e.target === t.element[0] ||
                      e.target === i ||
                      u.contains(i, e.target) ||
                      t.close();
                  });
                });
            },
            menufocus: function (e, t) {
              ...
              (s = t.item.data("ui-autocomplete-item")),
                ...
                (i = t.item.attr("aria-label") || s.value) &&
                  ...
                  u("<div>").text(i).appendTo(this.liveRegion));
            },
      ...
      _appendTo: function () {
        ...
        return (
          ((e =
            e &&
            (e.jquery || e.nodeType ? u(e) : this.document.find(e).eq(0))) &&
            e[0]) ||
      ...
      __response: function (e) {
        ...
        this._superApply(arguments),
          this.options.disabled ||
            ...
            this.liveRegion.children().hide(),
            u("<div>").text(t).appendTo(this.liveRegion));
      },
    }),
    u.ui.autocomplete
  );
